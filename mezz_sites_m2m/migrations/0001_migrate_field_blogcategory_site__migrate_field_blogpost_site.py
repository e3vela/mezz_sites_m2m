...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sites on 'BlogCategory'
        db.create_table('blog_blogcategory_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blogcategory', models.ForeignKey(orm['blog.blogcategory'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('blog_blogcategory_sites', ['blogcategory_id', 'site_id'])
        ...
        db.create_unique('blog_blogpost_sites', ['blogpost_id', 'site_id'])
